...
Hugging Face Spaces version (no launch logic)
"""
import gradio as gr
...
def chat(message: str, history: list) -> str:
    ...
    if not ANTHROPIC_API_KEY:
        return "⚠️ **Error**: ANTHROPIC_API_KEY not configured. Please set it in Secrets."
...
# HF Spaces will automatically launch this demo object
# No demo.launch() call needed!
