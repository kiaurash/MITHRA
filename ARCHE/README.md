...
Complete implementation of the ARCHE pipeline from the paper "ARCHE: A Novel Task to Evaluate LLMs on Latent Reasoning Chain Extraction" (arXiv:2511.12485).

This is a standalone project for symbolic reasoning extraction, separate from the MITHRA learning application.
...
ARCHE/
├── README.md                        # This file
├── arche_pipeline_design.md         # Complete pipeline architecture
├── arche_prompts.md                 # Full ARCHE prompts (from paper appendix)
├── validate_rlt.py                  # Python structural validator
├── arche_paper_analysis.md          # Working document with viewpoint extraction
├── arche_paper_rlt.dot              # Initial RLT extraction
├── arche_paper_rlt_corrected.dot    # First correction iteration
├── arche_paper_rlt_final.dot        # Final RLT version
